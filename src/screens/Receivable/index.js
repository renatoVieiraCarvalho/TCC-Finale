  ...
  const getData = () => {
    ...
    try {
      if(handleCategory === 'Todas'){
        db.transaction((tx) => {
            tx.executeSql(
                "SELECT * FROM Bills WHERE (SelectedStatus='Recebido' OR SelectedStatus='Receber') AND HandleDate=? ",
        ...
        db.transaction((tx) => {
          tx.executeSql(
              "SELECT * FROM Bills WHERE (SelectedStatus='Recebido' OR SelectedStatus='Receber') AND (HandleDate=?) AND (SelectedCategory=?) ",
  ...
  return (
    ...
    style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.textHeader}>Contas a receber</Text>
